...
namespace DanfeSharp.Modelo
{
    ...
    public class DanfeViewModel
    {
        ...
        /// </summary>
        public List<DetalhePagamentoViewModel> Pagamentos { get; set; }
        ...
        public DanfeViewModel()
        {
            ...
            Pagamentos = new List<DetalhePagamentoViewModel>();
        ...
        {
            return DanfeViewModelCreator.CriarDeStringXml(xml);
        }
        ...
        public enum enumTipoLeituraDeXML
        {
            NFe = 1,
            CFeSat = 2,
            NFCe = 3
        ...
        public enumTipoLeituraDeXML TipoLeituraDeXML { get; set; }
    }
}
